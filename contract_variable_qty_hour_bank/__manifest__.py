...

{
    ...
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-contract/contract_variable_qty_hour_bank',
    ...
    "installable": True,
    'depends': ['contract_variable_quantity', 'hr_timesheet','product','product_sale_contract'],
    "data": [
